...
const AboutMe = () => {
  return (
    <section id="about" className={classes.aboutContainer}>
      ...
      <picture>
        ...
        <div className={classes.profileRight}>
            ...
            <button className={(classes.btnSecondary)}><Link to="/portfolio" className={classes.linkPage}>Go To Portfolio</Link></button>
        </div>
