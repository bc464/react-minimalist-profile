...
const ManageContent = () => {
    ...
    const previousPage = () => navigate("/fylo");
    const nextPage = () => navigate("/bookmark")
  ...
  return (
    ...
    <picture>
        ...
        />
        <img src="./images/detail/mobile/image-manage-hero.jpg" className="profileView-heroImg"/>
      </picture>
    ...
    <section className='profile-main__content'>
        ...
        <div className='profile-main__right-box'>
            ...
            <div className='static-preview'>
                ...
                />
                <img src="./images/detail/mobile/image-manage-preview-1.jpg" className="profileView-previewImg"/>
            </picture>
            <picture>
                <source media="(min-width: 800px)" 
                ...
                />
                <img src="./images/detail/mobile/image-manage-preview-2.jpg" className="profileView-previewImg"/>
            </picture>
            </div>
        </div>
    </section>
